            ...
            return (
              <Pressable
                ...
                >
                  ...
                  <View>
                    <Text style={{fontSize: 25, color: '#fff', fontWeight: 700}}>{item.event}</Text>
                    <Text style={{fontSize: 18, color: '#fff', fontWeight: 500}}>{item.venue}</Text>
                    <Text style={{fontSize: 18, color: '#fff', fontWeight: 500}}>{item.date}</Text>
                    <Text style={{fontSize: 18, color: '#fff', fontWeight: 500}}>{item.time}</Text>
                  </View>
                </View>
              </Pressable>
            )
